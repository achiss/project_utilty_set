...
from src.share.utility.processor_password.source import generate_password_hash, check_password_string
...
class ProcessorPassword:
    ...
    def generate_hash(password_string: str) -> bytes:
        ...
        _result = generate_password_hash(
            password_string,
    ...
    def validate_hash(password_string: str,
                      hashed_password: bytes) -> bool: pass
